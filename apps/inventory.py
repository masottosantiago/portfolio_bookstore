...
from app import app, booksHeader, booksColumnsdB, dbbookscolumns, df, querydatafromdatabase, modifydatabase, publist
...
def return_2(click,rd,value,custid,tdata):
    header = 'Hello, ' + value + '!'
    d = rd[0]
...
def output_inventory(search_button,show_all,update,delete,newpubclick,rowid,author, 
                     title, isbn,table,input_isbn,publishing_date,input_author,
                     input_title,input_stocks,input_price,addnewpub,input_publisher,
                     input_publishername,input_publisheradd,input_publishercontact,
