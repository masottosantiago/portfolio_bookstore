...
def reports(report):
    if report == 'Bestsellers':
        ...
        bests = querydatafromdatabase(sqlbestseller,[],["ISBN 13", "Authors", "Title", "Publication Date","Publisher Name","Year", "Revenue (PhP)"]).iloc[0:20]
        ...
        for index,row in authorsdistinct.iterrows():
            ...
            addlay = (
             ...
             dash_table.DataTable(
                                ...
                                page_size=20,
                                page_action='none',
                                style_table={'width':'80%', 'margin-left':'10%', 'overflowY': 'auto'  },
